...
本學期每週二上課，第一週為 9/15（二）。共規劃 15 週實習課；11/10 為期中考週，1/5、1/12 彈性教學週。實際上課與繳交日期仍以授課教師公告為準。

| 週 | 日期 | 課程主題 | 學習重點 | 主要實作／產出 |
|---:|---|---|---|---|
| **1** | **9/15** | **GitHub 與開發環境建立** | Git、GitHub、Repository、VS Code、Clone、基本 Terminal 操作 | 建立 `115web_學號` Repository 並 Clone 至本機 |
| **2** | **9/22** | **Git 基礎與版本控制** | `status`、`add`、`commit`、`log`、`diff`、`push`、`pull`、`.gitignore` | 完成 Git Workflow 練習與多次 Commit |
| **3** | **9/29** | **HTML 網頁基礎** | HTML 結構、Heading、Paragraph、Link、Image、List、Table、Div | HW1：製作 `about.html` 個人自我介紹 |
| **4** | **10/6** | **CSS 與網頁版面設計** | CSS Selector、Class、ID、Box Model、Flexbox、基本 RWD | HW2：美化 About Me 並部署 GitHub Pages |
| **5** | **10/13** | **JavaScript 與 TypeScript 入門** | Node.js、npm、JS/TS 差異、型別、`const`、`let`、if、for、function | HW3：TypeScript 基礎程式練習 |
...
| **9** | **11/10** | **期中考週** | 不上實習課 |  |
| **10** | **11/17** | **HTTP、RESTful API 與 Express** | Request、Response、JSON、Status Code、GET、POST、PUT、DELETE、Express Route | HW5：建立自己的 REST API |
...
| **14** | **12/15** | **期末專案開發 I** | 專案需求、GitHub 協作、前端 Component、API 規劃、DB Schema | 建立團隊 Repository，完成專案架構與核心功能 |
| **15** | **12/22** | **期末專案開發 II** | 前後端整合、CRUD、表單驗證、錯誤處理、Git 協作 | 完成 Full Stack 網站主要功能 |
| **16** | **12/29** | **期末專案成果展示** | Demo、系統架構、功能說明、GitHub Repository 整理 | 完成網站 Demo 與成果展示 |
| **17** | **1/5** | **不上課** | 教師彈性教學週 |  |
| **18** | **1/12** | **不上課** | 教師彈性教學週 |  |
